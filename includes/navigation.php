...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container navContainer">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/menhely">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                ?>
                    <li class='<?php echo $kiemelt_class; ?>'>
                        <a href="/menhely/kiemelt">Kiemelt gazdikeresők</a>
                    </li>
                    <li class='<?php echo $kutyatar_class; ?>'>
                        <a href="/menhely/kutyatar">Kutyatár</a>
                    </li>
                    <li class='<?php echo $aboutus_class; ?>'>
                        <a href="/menhely/aboutus">Rólunk</a>
                    </li>
                    <li class='<?php echo $contact_class; ?>'>
                        <a href="/menhely/contact">Üzenet</a>
                    </li>
                    <li>
                        <a href="/menhely/index_eng.php" class="lang">ENG</a>
                    </li>
                    <!-- Blog Search Well -->
                    <li id="search">
